...
@section('content')
    ...
    <div class="w-full py-24 px-6 bg-cover bg-no-repeat bg-center relative z-10" style="background-image: url('https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=2100');">
        ...
        <div class="container max-w-4xl mx-auto text-center">
            <h1 class="text-xl leading-tight md:text-3xl text-center text-gray-100 mb-3">Dream Heute</h1>
            <p class="text-md md:text-lg text-center text-white ">Beauty is not a luxury.
                It is a necessity.</p>
    ...
    <div class="w-full px-6 py-12 bg-white">
        ...
        <div class="container max-w-4xl mx-auto text-center flex flex-wrap items-start md:flex-no-wrap">
            ...
            <div class="my-4 w-full md:w-1/3 flex flex-col items-center justify-center px-4">
                ...
                <h2 class="text-xl leading-tight mb-2"> La Muette, Auteuil, Porte Dauphine, Paris, Île-de-France</h2>
                <p class="mt-3 mx-auto text-sm leading-normal">At the heart of a prestigious private villa,
                    paved and planted with trees with a caretaker in residence, a charming house, mansion in absolute calm. </p>
            </div>
        ...
        <div class="container max-w-4xl mx-auto flex justify-center flex-wrap md:flex-no-wrap">
            <div class="w-full md:w-1-3">
                <h3 class="text-3xl mb-8 text-black leading-tight">
                    ...
                    <p class="mb-5">At times real estate can be a part of our history,
                    at times inspirations from new architectural elements, or at other
                    times simply beautiful examples of how you can transform
                    a space with the right interior design choices..</p>
                    <p>Whether you are attracted by
                    the beauty of the properties, the inspiration from browsing listings,
                    the desire to purchase a dream home or make an investment.</p>
            </div>
